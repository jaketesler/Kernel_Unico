...
// UART4 - internal serial imx6 --> sam3x (/dev/ttymxc3)
	...
	*/
	...
	MX6Q_PAD_KEY_ROW1__GPIO_4_9,							// pin 48
		//MX6Q_PAD_KEY_ROW1__UART5_RXD,		//Secondary UART5
	MX6Q_PAD_KEY_COL1__GPIO_4_8,							// pin 49
		//MX6Q_PAD_KEY_COL1__UART5_TXD,		//Secondary UART5
...
static unsigned int mx6q_set_in_outputmode_high[] = {
	...
	MX6Q_PAD_SD1_CLK__GPIO_MODE,  		//LED GPIO20
	MX6Q_PAD_DISP0_DAT9__GPIO_MODE,		//GPIO126
	MX6Q_PAD_DISP0_DAT6__GPIO_MODE,		//GPIO133
...
static unsigned int mx6q_set_in_inputmode[] = {	
	...
	MX6Q_PAD_KEY_ROW0__GPIO_MODE,		//UART4-RX
	MX6Q_PAD_KEY_COL0__GPIO_MODE,		//UART4-TX
#endif

	//MX6Q_PAD_SD1_DAT1__GPIO_MODE,   	//LED GPIO17, made output	
	//MX6Q_PAD_SD1_CLK__GPIO_MODE,		//LED GPIO20
	//MX6Q_PAD_DISP0_DAT9__GPIO_MODE,	//GPIO126
	//MX6Q_PAD_DISP0_DAT6__GPIO_MODE,	//GPIO133
	
	//MX6Q_PAD_CSI0_DAT10__GPIO_MODE,		//UART1-TX
	//MX6Q_PAD_CSI0_DAT11__GPIO_MODE,		//UART1-RX
	//MX6Q_PAD_EIM_D24__GPIO_MODE,  		//UART3-TX
	//MX6Q_PAD_EIM_D25__GPIO_MODE,   		//UART3-RX
	//MX6Q_PAD_CSI0_DAT13__GPIO_MODE,		//UART4-RX
	//MX6Q_PAD_CSI0_DAT12__GPIO_MODE,		//UART4-TX
	//MX6Q_PAD_CSI0_DAT16__GPIO_MODE,		//UART4-RTS
	//MX6Q_PAD_CSI0_DAT15__GPIO_MODE, 		//UART5-RX
	//MX6Q_PAD_CSI0_DAT14__GPIO_MODE,   	//UART5-TX
	MX6Q_PAD_KEY_ROW1__GPIO_MODE,			//2UART5-RX
	MX6Q_PAD_KEY_COL1__GPIO_MODE,			//2UART5-TX
	//MX6Q_PAD_GPIO_8__GPIO_MODE,			//canrx
	//MX6Q_PAD_GPIO_7__GPIO_MODE,			//cantx
